...
res\Toolbar.bmp
    ...
    update the IDR_MAINFRAME TOOLBAR array in segment.rc to add
    toolbar buttons.
/////////////////////////////////////////////////////////////////////////////
...
segmentDoc.h, segmentDoc.cpp - the document
    These files contain your CSegmentDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CSegmentDoc::Serialize).

segmentView.h, segmentView.cpp - the view of the document
    These files contain your CSegmentView class.
    CSegmentView objects are used to view CSegmentDoc objects.

res\segmentDoc.ico
    This is an icon file, which is used as the icon for MDI child windows
    for the CSegmentDoc class.  This icon is included by the main
    resource file segment.rc.
